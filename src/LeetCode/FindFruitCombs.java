...
public class FindFruitCombs {
    ...
    public static void main(String[] args) {
        ...
        String[] shoppingCart1 = {"orange","orange","orange","orange","kiwi", "apple", "apple", "banana", "orange", "banana"};
        ...
        String[] shoppingCart5 = {"apple", "apple", "orange", "orange", "banana", "apple", "banana", "banana"};
